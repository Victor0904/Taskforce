 ...
 */
class getCollaborateurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CollaborateurRepository' shared autowired service.
     *
     * @return \App\Repository\CollaborateurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CollaborateurRepository.php';

        return $container->privates['App\\Repository\\CollaborateurRepository'] = new \App\Repository\CollaborateurRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
