 ...
 */
class getAffectationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AffectationRepository' shared autowired service.
     *
     * @return \App\Repository\AffectationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AffectationRepository.php';

        return $container->privates['App\\Repository\\AffectationRepository'] = new \App\Repository\AffectationRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
